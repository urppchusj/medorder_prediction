...
#%%
_, targets, seqs, active_meds, active_classes, depas, _, _, _, _, _ = d.make_lists(get_valid=False)
...
#%%
eval_generator = TransformedGenerator(w2v_step, pse, le, targets, seqs, active_meds, active_classes, depas, W2V_EMBEDDING_DIM, SEQUENCE_LENGTH, BATCH_SIZE, shuffle=False)
