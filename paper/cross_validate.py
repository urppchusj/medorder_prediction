...
SAVE_PATH = os.path.join(os.getcwd(), 'paper', 'model', SAVE_STAMP + 'crossval')
...
for train, test in TimeSeriesSplit(n_splits=5).split(d.enc):
	...
	print('Fitting PSE...')
	pse_data = [[ap, ac, de] for ap, ac, de in zip(active_meds_train, active_classes_train, depa_train)]
