...
#%%
_, targets_train, seq_train, active_meds_train, active_classes_train, depa_train, targets_test, seq_test, active_meds_test, active_classes_test, depa_test = d.make_lists()
