...
#%%
_, targets_train, seq_train, active_meds_train, active_classes_train, depa_train, targets_val, seq_val, active_meds_val, active_classes_val, depa_val = d.make_lists()
